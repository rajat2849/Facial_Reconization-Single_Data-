...
data_path = 'D:/python/face_recognition/project2/Images/Rajat/'
data_path1 = 'D:/python/face_recognition/project2/Images/Atulika'
onlyfiles = [f for f in listdir([data_path],[data_path1]) if isfile(join(data_path,f))] #connect file

Training_Data, Labels = [], [] #martix store in both array

for i, files in enumerate(onlyfiles):
    image_path = ([data_path],[data_path1]) + onlyfiles[i]
